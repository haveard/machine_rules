...
"""
    ...
    def test_yaml_loader_validates_types(self):
        ...
        with pytest.raises(RuleValidationError, match="rules|list|array"):
            YAMLRuleLoader.from_dict({"name": "test", "rules": "not a list"})
