...
class TestRule:
    ...
    def test_rule_creation(self):
        ...
        rule = Rule(name="test_rule", condition=condition, action=action, priority=5)
...
class TestRuleExecutionSet:
    ...
    def test_rule_priority_sorting(self):
        ...
        execution_set = RuleExecutionSet(name="test_set", rules=[rule1, rule2, rule3])
...
class TestMachineAdapter:
    ...
    def test_machine_rule_session(self):
        from machine_rules.adapters.machine_adapter import MachineRuleSession
        from machine_rules.api.execution_set import Rule, RuleExecutionSet
    ...
    def test_machine_rule_administrator(self):
        ...
        rule = Rule(
            name="test_rule", condition=lambda f: True, action=lambda f: "result"
        )
        execution_set = RuleExecutionSet(name="test_set", rules=[rule])
...
class TestExecutionStrategy:
    ...
    def test_default_strategy_is_all_matches(self):
        ...
        execution_set = RuleExecutionSet(name="test_set", rules=[rule1, rule2])
...
class TestThreadSafety:
    ...
    def test_concurrent_rule_registration(self):
        ...
        def register_rules(rule_set_id):
            try:
                ...
                execution_set = RuleExecutionSet(
                    name=f"set_{rule_set_id}", rules=[rule]
                )
        ...
        threads = [
            threading.Thread(target=register_rules, args=(i,)) for i in range(50)
        ]
    ...
    def test_concurrent_session_operations(self):
        ...
        threads = [threading.Thread(target=execute_rules, args=(i,)) for i in range(30)]
